	...
	return (
		<div className="w-full bg-white rounded-3xl p-6">
			...
			<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
				...
				<Button
					variant="outline"
					className="flex flex-col items-center justify-center p-3 bg-gray-100 rounded-md h-36 w-28 border-0">
					<div className="w-12 h-12 text-white rounded-full bg-[#3BC83B] mb-2 flex justify-center items-center">
						<Check />
					</div>
					<p className="font-semibold text-black text-wrap text-sm">
						Open Live Account
					</p>
				</Button>
